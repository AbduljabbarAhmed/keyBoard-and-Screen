...
jne ALTBR
alt:
or byte[STATUS],0x10 ; set
jmp checkAgain
ALTBR:
cmp al,0xB8
jne CHECK_ALT
alt_br:
and byte[STATUS],0xEF ; reset
jmp checkAgain


CHECK_ALT:
test byte[STATUS],0x10 ; 
jz Arrows
RED:
cmp al,0x13
jne BLUE
...
length : dd 0
boundedBy: dd 0,0
MyMemory: times(25*80*2) db 0
PREVIOUS_STATUS: times(25*80*2) db 0
